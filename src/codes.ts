...
export function charStroke(ch: string): Stroke | undefined {
  return chars.get(ch);
}
...
export const KEYBOARD_KEYS = [
  ...new Set([...Object.values(KEY), ...[...chars.values()].map((stroke) => stroke.code), ...Object.values(NAMED)]),
];

export const CHARS: ReadonlyMap<string, Stroke> = chars;
